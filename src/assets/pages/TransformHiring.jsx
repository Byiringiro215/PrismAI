...
<h3 className='text-white  font-extrabold'>Transform Your <span className='text-blue-500'> Hiring</span> <span className='bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400'>Process</span></h3>
